...
public sealed record GetConfigValueRevisionsQuery(Guid ProjectId, Guid ConfigItemId, string EnvironmentName)
	: IQuery<IReadOnlyList<ConfigValueRevisionSummaryView>>;

public sealed class GetConfigValueRevisionsQueryHandler(
	IProjectRepository projects,
	IProjectAuthorizationService authorization,
	IReadDbContext db)
	: IQueryHandler<GetConfigValueRevisionsQuery, IReadOnlyList<ConfigValueRevisionSummaryView>>
{
	public async Task<IReadOnlyList<ConfigValueRevisionSummaryView>> HandleAsync(GetConfigValueRevisionsQuery query, CancellationToken ct)
	{
