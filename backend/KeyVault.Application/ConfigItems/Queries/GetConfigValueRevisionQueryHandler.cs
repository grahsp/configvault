...
public sealed record GetConfigValueRevisionQuery(
	Guid ProjectId,
	Guid ConfigItemId,
	string EnvironmentName,
	uint Revision) : IQuery<ConfigValueRevisionView?>;

public sealed class GetConfigValueRevisionQueryHandler(
	IProjectRepository projects,
	IProjectAuthorizationService authorization,
	IReadDbContext db,
	IEnvelopeEncryptionService encryption)
	: IQueryHandler<GetConfigValueRevisionQuery, ConfigValueRevisionView?>
{
	public async Task<ConfigValueRevisionView?> HandleAsync(GetConfigValueRevisionQuery query, CancellationToken ct)
	{
