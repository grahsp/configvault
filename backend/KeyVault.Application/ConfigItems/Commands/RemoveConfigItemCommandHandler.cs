...
public sealed record RemoveConfigItemCommand(Guid ProjectId, Guid ConfigItemId) : ICommand<Unit>;

public sealed class RemoveConfigItemCommandHandler(
	IProjectRepository projects,
	IProjectAuthorizationService authorization,
	IConfigItemBatchPlanner planner,
	IConfigItemMutationExecutor executor)
	: ICommandHandler<RemoveConfigItemCommand, Unit>
{
	public async Task<Unit> HandleAsync(RemoveConfigItemCommand command, CancellationToken ct)
	{
