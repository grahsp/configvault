...
namespace KeyVault.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260508054848_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeyVault.Domain.ConfigItems.ConfigValueRevision", b =>
                {
                    b.HasOne("KeyVault.Domain.ConfigItems.ConfigValue", "ConfigValue")
                        .WithMany("Revisions")
                        .HasForeignKey("ConfigItemId", "EnvironmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ConfigValue");
                });
