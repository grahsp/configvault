        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_config_value_revisions_config_values_ConfigItemId_Environme~",
                        columns: x => new { x.ConfigItemId, x.EnvironmentId },
                        principalTable: "config_values",
                        principalColumns: new[] { "ConfigItemId", "EnvironmentId" },
                        onDelete: ReferentialAction.Cascade);
                });
